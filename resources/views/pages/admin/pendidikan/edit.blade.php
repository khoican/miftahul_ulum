...
<div class="p-5 border border-slate-300 bg-white rounded-lg shadow-lg mb-5">
    <form action="">
        <div>
            <div class="mb-6">
                <label for="title" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Instansi <span class="text-red-500 font-bold">*</span></label>
                <input type="text" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
            </div>
            <div class="mb-6">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Logo Instansi <span class="text-red-500 font-bold">*</span></label>
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">Silahkan masukkan gambar dengan format JPG, JPEG, PNG, atau SVG</p>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="photo_input" type="file" required>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-300" id="file_input_help">Silahkan masukkan gambar dengan format JPG, JPEG, PNG, atau SVG</p>
            </div>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="pdf_input" type="file">
