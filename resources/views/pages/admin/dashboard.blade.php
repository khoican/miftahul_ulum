...
<div class="inline-flex gap-5 w-full mb-10 flex-col lg:flex-row">
    <div class="w-full lg:w-3/6 border-2 border-green-500 bg-white p-8 rounded-2xl shadow flex justify-between items-center">
        <svg class="w-10 h-10 text-green-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<div class="p-5 border border-slate-300 bg-white rounded-lg shadow-lg mb-5">
    <div class="mb-5 flex justify-between items-center">
        ...
        <a href="" class="p-3 bg-green-500 rounded-lg text-white font-medium hover:bg-green-600 shadow">Kelola Prestasi</a>
    </div>
...
<div class="p-5 border border-slate-300 bg-white rounded-lg shadow-lg">
    <div class="mb-5 flex justify-between items-center">
        <div class="flex items-center gap-4">
        ...
        <a href="" class="p-3 bg-green-500 rounded-lg text-white font-medium hover:bg-green-600 shadow">Kelola Kagiatan</a>
    </div>
