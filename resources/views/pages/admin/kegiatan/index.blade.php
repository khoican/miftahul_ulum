...
<div class="p-5 border border-slate-300 bg-white rounded-lg shadow-lg mb-5">
    <div class="mb-5 flex justify-between md:items-center flex-col md:flex-row">
        ...
        <a href="/kegiatan/create" class="p-3 bg-green-500 rounded-lg text-white font-medium hover:bg-green-600 shadow flex items-center gap-2 mt-3 md:mt-0">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="inline-flex items-center gap-3 justify-center">
                            <a href="/kegiatan/edit" class="p-3 rounded-lg bg-yellow-300 hover:bg-yellow-500 text-white">
