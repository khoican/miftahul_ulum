...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
            ...
            <li>
                <button type="button" class="flex items-center px-3 py-2 w-full p-2 text-base text-gray-900 hover:text-white transition duration-75 rounded-lg group hover:bg-green-600 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Pendidikan</span>
                ...
                <ul id="dropdown-example" class="hidden py-2 space-y-2">
                    <li>
                        <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-600 hover:text-white dark:text-white dark:hover:bg-gray-700">TPQ</a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-600 hover:text-white dark:text-white dark:hover:bg-gray-700">TK</a>
                    </li>
                    <li>
                        <!-- Modal toggle -->
                        <button data-modal-target="static-modal" data-modal-toggle="static-modal" class="flex items-center gap-1 w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-green-600 hover:text-white dark:text-white dark:hover:bg-gray-700" type="button">
            ...
            <li>
                <a href="/kegiatan" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="/prestasi" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
