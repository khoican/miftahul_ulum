...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('pendidikan') }}" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
            ...
            <li>
                <a href="{{ route('prestasi') }}" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
            ...
            <li>
                <a href="{{ route('kegiatan') }}" class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white hover:text-white hover:bg-green-600 dark:hover:bg-gray-700 group">
