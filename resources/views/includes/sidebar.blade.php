        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar"
                    type="button"
                    class="inline-flex items-center p-2 text-sm rounded-lg sm:hidden hover:text-white hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <div class="flex items-center">
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button"
                            class="flex items-center gap-2 text-green-600 text-sm px-3 py-2 border border-green-600 hover:bg-green-600 hover:text-white rounded-lg focus:ring-4 focus:ring-green-100 dark:focus:ring-green-800"
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }}  dark:hover:bg-gray-700 group">
            ...
            <li>
                <button type="button" id="dropdownMasterData" aria-controls="dropdown-example"
                    data-collapse-toggle="dropdown-example"
                    class="flex items-center px-3 py-2 w-full text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/pendidikan*') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        width="16" height="16" fill="none" viewBox="0 0 16 16" id="data">
                ...
                <div id="dropdown-example" class="hidden">
                    <ul class="space-y-2 font-medium" aria-labelledby="dropdownLargeButton">
                        <li>
                            <a href="{{ route('histori') }}"
                                class="flex items-center px-6 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/histori') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                                <svg class="w-6 h-6 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24"
                                    id="history">
                                    <path
                                        d="M12,1A11.052,11.052,0,0,0,5,3.521V3A1,1,0,0,0,3,3V6c0,.025.012.047.014.072a1.011,1.011,0,0,0,.038.188,1.035,1.035,0,0,0,.062.18.991.991,0,0,0,.1.156.931.931,0,0,0,.074.111c.018.018.042.025.061.041s.028.038.047.053a.962.962,0,0,0,.108.051.952.952,0,0,0,.186.087.968.968,0,0,0,.184.037A1,1,0,0,0,4,7H7A1,1,0,0,0,7,5H6.359A8.991,8.991,0,1,1,3,12a1,1,0,0,0-2,0A11,11,0,1,0,12,1Z">
                                    </path>
                                    <path d="M12,13a1,1,0,0,0,1-1V6a1,1,0,0,0-2,0v5H8a1,1,0,0,0,0,2Z"></path>
                                </svg>
                        ...
                        <li>
                            <a href="{{ route('kontak') }}"
                                class="flex items-center px-6 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/kontak*') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                                <svg class="w-6 h-6 dark:text-white" aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    enable-background="new 0 0 32 32" viewBox="0 0 32 32" id="contact">
                                    <path
            ...
            <li>
                <a href="{{ route('pendidikan') }}"
                    class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/pendidikan*') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <a href="{{ route('prestasi') }}"
                    class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/prestasi*') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="currentColor" viewBox="0 0 20 20">
                        <path
            ...
            <li>
                <a href="{{ route('kegiatan') }}"
                    class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('dashboard/kegiatan*') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
                <a href="{{ route('home') }}"
                    class="flex items-center px-3 py-2 text-gray-900 rounded-lg dark:text-white {{ request()->is('/') ? 'text-white bg-green-600' : 'hover:text-white hover:bg-green-600' }} dark:hover:bg-gray-700 group">
                    <svg class="w-6 h-6 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="p-4 md:p-5 space-y-4">
                <form>
                    ...
                    <div class="text-end">
                        ...
                        <button type="submit"
                            class="text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
